...
export const GalleryImages = [
  ...
  [
    { src: '/Hroom1.webp', alt: 'Rooms' },
    { src: '/Hroom2.webp', alt: 'Rooms' },
    { src: '/Hroom3.webp', alt: 'Rooms' },
    { src: '/Hroom4.webp', alt: 'Rooms' },
    { src: '/Hroom5.webp', alt: 'Rooms' },
    { src: '/Hroom6.webp', alt: 'Rooms' },
    { src: '/Hroom7.webp', alt: 'Rooms' },
    { src: '/Hroom8.webp', alt: 'Rooms' },
  ],
