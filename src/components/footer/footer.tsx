                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.facebook.com/profile.php?id=61574848059131" target='_blank' className="text-primary hover:text-red-500">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                                </svg>
                            </a>
                            <a href="https://www.instagram.com/dolmapos/" target='_blank' className="text-primary hover:text-red-500">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div >
                        ...
                        <ul className="text-muted-foreground font-semibold  list-none p-0">
                            ...
                            <li className="mb-2"><Link href="/room" className="hover:text-primary">Room & Rate</Link></li>
                            <li className="mb-2"><Link href="/experiences" className="hover:text-primary">Experiences</Link></li>
                            <li className="mb-2"><Link href="/local" className="hover:text-primary">Local Cuisine</Link></li>
